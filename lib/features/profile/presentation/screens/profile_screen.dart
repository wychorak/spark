...
// ── Mock Data ──
class _MockProfile {
  static const String name = 'Aleksandra';
  static const int age = 24;
  static const bool isVerified = true;
  static const bool isPremium = false;
  static const List<String> modes = ['relationship', 'friends'];
  static const int likes = 147;
  static const int matches = 23;
  static const String spotifyTrack = 'Taco Hemingway - Deszcz na betonie';
  static const String spotifyArtist = 'Taco Hemingway';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              _ProfileCard(screenWidth: size.width),
              const Gap(AppDimensions.spacing24),
              // ── Stats Row ──
              const _StatsRow(),
              const Gap(AppDimensions.spacing24),
...
class _ProfileCard extends StatelessWidget {
  const _ProfileCard({required this.screenWidth});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          '${_MockProfile.name}, ${_MockProfile.age}',
                          style: GoogleFonts.outfit(
                            fontSize: 28,
                            fontWeight: FontWeight.w700,
                            color: AppColors.textPrimary,
                    ...
                    Wrap(
                      ...
                      children: _MockProfile.modes.map((mode) {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(
          child: _StatCard(
            value: '${_MockProfile.likes}',
            label: 'polubien',
            icon: Icons.favorite,
            color: AppColors.neonPink,
            isBlurred: !_MockProfile.isPremium,
          ),
        ),
        const Gap(AppDimensions.spacing16),
        Expanded(
          child: _StatCard(
            value: '${_MockProfile.matches}',
            label: 'matchow',
